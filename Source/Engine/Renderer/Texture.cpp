...
namespace nc {
	...
	bool Texture::CreateTexture( int width, int height ) {
		...
		glTexImage2D( m_target, 0, GL_DEPTH_COMPONENT24, width, height, 0, GL_DEPTH_COMPONENT, GL_UNSIGNED_BYTE, NULL );
	...
	bool Texture::CreateDepthBuffer( int width, int height ) {
